            ...
            <div className='flex flex-col items-center justify-center min-w-80 mx-auto  md:min-w-96'>
                ...
                <div className="w-full p-6 bg-gray-500 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-gray-100">
                    ...
                    <form onSubmit={handleSubmit} action="">
                        ...
                        <div>
 						<button className='btn btn-block btn-sm mt-2 bg-orange-400 hover:bg-orange-500'>
                        ...
                        <Link to= '/signup' className='font-semibold  text-sm  w-full border  rounded-full flex  justify-center items-center  p-2  hover:underline hover:decoration-orange-600 border-orange-700 cursor-pointer' >
